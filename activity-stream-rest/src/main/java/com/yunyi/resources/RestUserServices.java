...
public class RestUserServices implements ResourceContainer {
	...
	@GET
	@Path("/listusers/{offet}")
	public Response getListUserName(@Context SecurityContext sc, @PathParam("offet") Integer offset)
